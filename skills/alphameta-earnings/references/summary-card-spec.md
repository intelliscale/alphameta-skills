...
|--------|----------|-----|-------------|
| Revenue | $XX.XB | +XX% | Beat +X.X% |
| Net Income | $X.XB | +XX% | Beat +X.X% |
| Non-GAAP NI | $X.XB | +XX% | Beat +X.X% |
...
|---------|---------|-------|-----|
| [Segment A] | $XX.XB | XX% | +XX% |
| [Segment B] | $XX.XB | XX% | +XX% |
| [Segment C] | $XX.XB | XX% | +XX% |
```
...
■ [🟠 Weakened] **Margin expansion story under pressure**
  AI capex doubling to >$36B creates near-term compression risk.

■ [🔵 New Focus] **AI ecosystem emerging**
  New AI products creating additional monetization surface.
```
